...
export const CIERRES_JUDICIALES = [
    ["2019-01-02", "2019-01-09"],   // nuevo
    ["2019-07-11", null],            // nuevo
    ["2019-12-03", null],            // nuevo
    ["2019-12-30", "2020-01-10"],   // extendido desde 2020-01-01
    ...
    ["2024-07-15", null],            // nuevo
    ["2024-08-27", "2024-08-28"],
    ["2024-12-20", "2025-01-10"],
    ["2025-03-18", null],            // nuevo
...
export const RESOLUCIONES_SUSPENSION = [
    ...
    {
        resolucion: "Circular interna 013 del 18 de abril de 2024",
        inicio: "2024-04-19",
        fin: "2024-04-19"
    },
    {
        resolucion: "Circular interna 017 del 12 de julio de 2024",
        inicio: "2024-07-15",
        fin: "2024-07-15"
    },
    {
   ...
   /*---------------------2025---------------------------*/
   {
      resolucion: "Circular interna 06 del 17 de marzo de 2025",
      inicio: "2025-03-18",
      fin: "2025-03-18"
   },
   {
